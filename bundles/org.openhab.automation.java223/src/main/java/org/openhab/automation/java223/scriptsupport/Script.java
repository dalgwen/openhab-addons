...
public abstract class Script {
    ...
    protected @InjectBinding(named = "RuleSupport.automationManager") @NonNullByDefault({}) ScriptedAutomationManager automationManager;

    // for transformation support
    protected @InjectBinding(mandatory = false) @Nullable Object input;
