...
This example shows how to use JSR223 from openHAB without using the code generated by Java223. It installs a rule waiting for item `r` to change, and sends a message over the MQTT broker `b`. Put in openhab/automation/jsr223/m.java:
