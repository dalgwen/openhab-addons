...
/**
 * Test class for raw button press
 *
 * @author Gwendal ROULLEAU - Initial contribution
 */
@ExtendWith(MockitoExtension.class)
@NonNullByDefault
public class TimedEventRawButtonProfileTest {
    ...
    @NonNullByDefault({})
    TimedEventRawButtonProfile timedEventProfile;
    ...
    public void init(@Nullable Map<@Nullable String, @Nullable Object> conf) {
        ...
        timedEventProfile = new TimedEventRawButtonProfile(profileCallBack, profileContext, OnOffType.ON,
                OnOffType.OFF);
    }
    ...
    public void testTriggerOnePress() throws InterruptedException {
        ...
        // nothing because default is two press
        Thread.sleep(DELAYEND);
    }

    @Test
    public void testTriggerTwoPressOnButton() throws InterruptedException {
        ...
        verify(profileCallBack).sendCommand(eq(OnOffType.ON));
        verify(profileCallBack).sendCommand(eq(OnOffType.OFF));
    }
