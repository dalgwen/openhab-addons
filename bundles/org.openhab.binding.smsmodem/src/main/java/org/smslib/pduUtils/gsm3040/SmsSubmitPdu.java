...
public class SmsSubmitPdu extends Pdu {
    ...
    public void setTpRd(int value) {
        setFirstOctetField(PduUtils.TP_RD_MASK, value,
                new int[] { PduUtils.TP_RD_ACCEPT_DUPLICATES, PduUtils.TP_RD_REJECT_DUPLICATES });
    }
    ...
    public void setTpVpf(int value) {
        setFirstOctetField(PduUtils.TP_VPF_MASK, value,
                new int[] { PduUtils.TP_VPF_INTEGER, PduUtils.TP_VPF_NONE, PduUtils.TP_VPF_TIMESTAMP });
    }
    ...
    public void setTpSrr(int value) {
        setFirstOctetField(PduUtils.TP_SRR_MASK, value,
                new int[] { PduUtils.TP_SRR_NO_REPORT, PduUtils.TP_SRR_REPORT });
    }
    ...
    protected String pduSubclassInfo() {
        ...
        sb.append("\n");
        // dcs
        sb.append("TP-DCS: " + PduUtils.byteToPdu(getDataCodingScheme()) + " (" + PduUtils.decodeDataCodingScheme(this)
