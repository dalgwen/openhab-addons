...
public class Common {
    ...
    public static String dumpRoutingTable(OutboundMessage message) {
        ...
        b.append(String.format("Message Recipient: %s%s", message.getRecipientAddress(),
    ...
    public static byte[] stringToBytes(String data) {
        ...
        for (int i = 0; i < data.length(); i += 2) {
            int value = (Integer.parseInt("" + data.charAt(i), 16) * 16)
                    + (Integer.parseInt("" + data.charAt(i + 1), 16));
