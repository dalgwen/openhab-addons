...
/**
 * This makes a MusicAssistant Player serve as an {@link org.openhab.core.audio.AudioSink}
 *
 * @author Mark Hilbush - Initial contribution
 * @author Mark Hilbush - Add callbackUrl
 */
@NonNullByDefault
public class MusicAssistantAudioSink extends AudioSinkSync {
    private final Logger logger = LoggerFactory.getLogger(MusicAssistantAudioSink.class);
    ...
    public MusicAssistantAudioSink(MusicAssistantPlayerHandler playerHandler, AudioHTTPServer audioHTTPServer,
            @Nullable String callbackUrl) {
        this.playerHandler = playerHandler;
        this.audioHTTPServer = audioHTTPServer;
        this.callbackUrl = callbackUrl;
        if (callbackUrl != null && !callbackUrl.isEmpty()) {
            logger.debug("MusicAssistant AudioSink created with callback URL: {}", callbackUrl);
        }
    }
