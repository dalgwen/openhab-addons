 ...
 */
package org.openhab.binding.musicassistant.internal.discovery;
...
import org.openhab.binding.musicassistant.internal.handler.MusicAssistantPlayer;
import org.openhab.binding.musicassistant.internal.handler.MusicAssistantPlayerEventListener;
...
/**
 * When a {@link MusicAssistantServerHandler} finds a new MusicAssistant Player we will
...
public class MusicAssistantPlayerDiscoveryService extends
    ...
    /**
     * Discovers MusicAssistant Players attached to a MusicAssistant Server
     */
    public MusicAssistantPlayerDiscoveryService() {
        super(MusicAssistantServerHandler.class, MusicAssistantPlayerHandler.SUPPORTED_THING_TYPES_UIDS, TIMEOUT, true);
    ...
    public void initialize() {
        ...
        // Register the PlayerListener with the MusicAssistantServerHandler
        thingHandler.registerMusicAssistantPlayerListener(this);
    }

    @Override
    public void dispose() {
        // Unregister the PlayerListener from the MusicAssistantServerHandler
        thingHandler.unregisterMusicAssistantPlayerListener(this);
    ...
    protected void startScan() {
        logger.debug("startScan invoked in MusicAssistantPlayerDiscoveryParticipant");
