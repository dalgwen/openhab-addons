...
/**
 * This {@link MusicAssistantNotificationListener}- is a type of PlayerEventListener
 ...
 */
@NonNullByDefault
public final class MusicAssistantNotificationListener implements MusicAssistantPlayerEventListener {
    private final Logger logger = LoggerFactory.getLogger(MusicAssistantNotificationListener.class);
    ...
    MusicAssistantNotificationListener(String playerMAC) {
