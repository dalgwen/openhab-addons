...
import static org.openhab.binding.musicassistant.internal.MusicAssistantBindingConstants.MUSICASSISTANTSERVER_THING_TYPE;
...
import org.openhab.binding.musicassistant.internal.utils.HttpUtils;
import org.openhab.binding.musicassistant.internal.utils.MusicAssistantCommunicationException;
import org.openhab.binding.musicassistant.internal.utils.MusicAssistantNotAuthorizedException;
...
@Component
@NonNullByDefault
public class MusicAssistantServerDiscoveryParticipant implements UpnpDiscoveryParticipant {
    private final Logger logger = LoggerFactory.getLogger(MusicAssistantServerDiscoveryParticipant.class);
    ...
    public Set<ThingTypeUID> getSupportedThingTypeUIDs() {
        return Set.of(MUSICASSISTANTSERVER_THING_TYPE);
    }
    ...
    public @Nullable DiscoveryResult createResult(RemoteDevice device) {
        ...
        if (uid != null) {
            ...
            try {
            ...
            } catch (MusicAssistantNotAuthorizedException e) {
                ...
                cliPort = defaultCliPort;
            } catch (MusicAssistantCommunicationException e) {
    ...
    public @Nullable ThingUID getThingUID(RemoteDevice device) {
        if (device.getDetails().getFriendlyName() != null) {
            if (device.getDetails().getModelDetails().getModelName().contains(MODEL_NAME)) {
                ...
                return new ThingUID(MUSICASSISTANTSERVER_THING_TYPE,
