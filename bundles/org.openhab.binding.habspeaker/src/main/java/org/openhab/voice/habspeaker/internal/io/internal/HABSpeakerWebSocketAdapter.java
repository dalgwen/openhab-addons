...
import org.openhab.binding.habspeaker.internal.io.HABSpeakerIOListener;
...
public class HABSpeakerWebSocketAdapter implements HABSpeakerIOManager, WebSocketAdapter {
    ...
    private final ScheduledExecutorService executor = ThreadPoolManager.getScheduledPool("binding-habspeaker");
